...
//    self.navigationItem.leftBarButtonItem = [UIBarButtonItem itemWithimage:[UIImage imageNamed:@"iv_left_back"] highImage:[UIImage imageNamed:@"iv_left_back"] target:self action:@selector(closeItemClicked)];
}
...
-(UIBarButtonItem*)customBackBarItem{
    if (!_customBackBarItem) {
        UIImage* backItemImage = [[UIImage imageNamed:@"iv_left_back"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        UIImage* backItemHlImage = [[UIImage imageNamed:@"iv_left_back"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
...
//        [backButton.titleLabel setFont:[UIFont systemFontOfSize:17]];
        ...
        [backButton setImageEdgeInsets:UIEdgeInsetsMake(0, -5, 0, 10)];
